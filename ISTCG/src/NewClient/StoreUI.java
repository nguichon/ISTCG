...
public class StoreUI extends Composite {
    ...
    public StoreUI(Composite parent, int style, final ClientMain main,
            TabItem tab) {
        super(parent, style);
        this.main = main;
        this.tab = tab;
        ...
        // TODO preview
        // preview text
        // **curItem = new StoreItem(this, SWT.None, "0", 0, "Name",
        // "Decription", this);
    ...
    // Current item
    /* ******
     * public StoreItem GetCur() { return curItem; }
     * 
     * public void SetCur(StoreItem it) { curItem = it;
     * 
     * redraw(); }
     */
